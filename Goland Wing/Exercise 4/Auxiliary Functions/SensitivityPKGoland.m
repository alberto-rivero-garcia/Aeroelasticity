function UF=SensitivityPKGoland(Ne,Nd,Umax,Nu,params)
...
%and making the result easier to use. It's modified to simplify sensitivity
%analyses, receiving some parameters in a parameter structure. 
...
e=(0.33*c-b)/b;     %[-]
rho=1.225;          %[kg/m^3]
Clalpha=params.Clalpha;        %[1/rad]

% First, solve the coupled bending-torsion problem to determine modal shapes. 
[fr,qr,FEMdata]=SensitivityFEM_CoupledBendingTorsion(Ne,Nd,params);
