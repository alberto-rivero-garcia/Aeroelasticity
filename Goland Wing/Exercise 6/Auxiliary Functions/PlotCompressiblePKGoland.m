function PlotCompressiblePKGoland(Ne,Nd,Umax,Nu)
%this function wrapper plots the frequency and g vs airspeed curves for the
% compressible Goland Wing with Ne elements,  Nd modes and a set of airspeeds
% uniformly spread out between 0 and Umax, with Nu elements. 
