function [KK_local,MM_local]=Task5_Parametric_RotatingLocalElementMatrices(xl,xr,Omega,R,f_eps,eps_waypoints)
...
%v2 modifies torsional inertia according to the change in cg related to
%epsilon. 
