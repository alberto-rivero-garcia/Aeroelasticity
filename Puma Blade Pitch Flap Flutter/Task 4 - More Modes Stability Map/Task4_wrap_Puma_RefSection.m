function [safe,convergence]=Task4_wrap_Puma_RefSection(Ne,Nd,Ktheta,f_eps,eps_waypoints,solparams)
...
%v5 uses the continuation algorithm developed in v3, modified to handle
...
[fr,qr,FEMdata,FEMCheck]=Task4_Parametric_FEM_RotatingCoupledBendingTorsion(Ne,Nd,Ktheta,f_eps,eps_waypoints);
