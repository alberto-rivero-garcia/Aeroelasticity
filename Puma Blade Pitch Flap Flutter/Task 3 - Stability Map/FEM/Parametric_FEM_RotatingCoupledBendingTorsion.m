function [fr,qr,FEMdata,FEMCheck]=Parametric_FEM_RotatingCoupledBendingTorsion(Ne,Nd,Ktheta,f_eps,eps_waypoints)
...
for i=1:Ne
    ...
    [KKlocal,MMlocal]=Parametric_RotatingLocalElementMatrices(b_pos(i),b_pos(i+1),Omega,R,f_eps,eps_waypoints);
